{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzDateTimePicker     TDateTimePicker descendant--adds custom framing, Format
                          property, calendar colors, etc.
...
function TRzDateTimePicker.GetColor: TColor;
begin
  Result := inherited Color;
end;

procedure TRzDateTimePicker.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
...
function TRzDateTimePicker.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzDateTimePicker.IsFocusColorStored: Boolean;
begin
...
begin
  ...
  begin
    ...
    RedrawWindow( Handle, @R, 0, rdw_Frame or rdw_Invalidate or rdw_UpdateNow or rdw_NoErase );
  end;
...
procedure TRzDateTimePicker.MouseEnter;
begin
...
procedure TRzDateTimePicker.MouseLeave;
begin
