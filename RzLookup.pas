{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzLookupDialog       When launched, displays a dialog contains an edit field
                          and a list box.  Allows a user to select an item from
                          a list using more space than just a combo box
                          drop-down list.
