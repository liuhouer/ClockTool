{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzStringGrid         Enhanced StringGrid that supports Custom Framing and
                          additional display options for grid cells.
...
function TRzStringGrid.GetColor: TColor;
begin
  Result := inherited Color;
end;


procedure TRzStringGrid.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
...
function TRzStringGrid.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzStringGrid.IsFocusColorStored: Boolean;
begin
  Result := NotUsingController and ( ColorToRGB( FFocusColor ) <> ColorToRGB( Color ) );
end;


function TRzStringGrid.NotUsingController: Boolean;
begin
...
procedure TRzStringGrid.MouseEnter;
begin
...
procedure TRzStringGrid.MouseLeave;
begin
...
procedure TRzStringGrid.GridRectToScreenRect( GridRect: TGridRect; var ScreenRect: TRect; IncludeLine: Boolean );
