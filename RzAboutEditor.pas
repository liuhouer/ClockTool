{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzAboutBoxProperty   About Box property editor
...
resourcestring
  ...
  sCopyrightDate = '1995-2003';
  sProductVersion  = 'Version 3.0.10';
...
procedure TRzAboutEditDlg.LblTitleMouseDown(Sender: TObject;
