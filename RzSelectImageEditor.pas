{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzSelectImageEditor  Provides a quick way of selecting glyphs for 
                        TRzToolarButton and TRzToolButton components.
  TRzToolButtonEditor   Adds a context menu to quickly change several properties 
                        of a TRzToolButton.
  TRzBitBtnEditor       Adds a context menu to quickly change several properties 
                        of a TRzMenuButton.
  TRzMenuButtonEditor   Adds a context menu to quickly change several properties 
                        of a TRzMenuButton.

  TRzCustomImageIndexProperty  Displays image index values (and each image) 
                               associated with an ImageList.
...
begin
  ...
  Result := ( GetComponent( 0 ) as TRzGroup ).SmallImageList;
end;
...
begin
  case Index of
    ...
    begin
      ...
      BitBtn.HotTrackColor := $003CC7FF;
      BitBtn.HighlightColor := $00F48D6A;
      BitBtn.Color := $00F0F4F4;
      Designer.Modified;
    end;
  end; { case }
...
var
  ...
  P: TPoint;
begin
  if ( FObject <> nil ) and ( FObject is TControl ) and ( CompOwner <> nil ) then
  begin
