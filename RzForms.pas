{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzFormState          Automatically stores the position, size, and state
                          (maximized or normal) of a form.
  TRzFormShape          Custom image component that removes transparent areas of
                          the image from the form itself.
...
begin
  ...
  begin
    // If the form's state has already been saved, then we want to reset the form's Position property to poDesigned.
    // This way the form will be positioned according to the values stored in the persistent store and not by
    // the initial value of the Position property.
