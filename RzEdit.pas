{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzCustomEdit         Base class for all Raize edit-style components--supports
                          Custom Framing and true text alignment.
  TRzEdit               Published version of TRzCustomEdit.
  TRzNumericEdit        Edit control for entering numeric data (integers and
                          floating-point numbers).
  TRzMaskEdit           TMaskEdit descendant--adds Custom Framing support.
  TRzExpandEdit         Edit field can expand to a larger size on enter, or via
                          mouse click.
  TRzColorEdit          Edit field that allows user to pick a color from a popup
                          TRzColorPicker.
  TRzDateTimeEdit       Edit field for entering dates and times.  Allows user to
                          pick date from popup TRzCalendar.
  TRzMemo               Enhanced TMemo--supports Custom Framing, Line & Column
                          properties and events.
  TRzRichEdit           Enhanced TRichEdit--supports Custom Framing, Line &
                          Column properties and events.
  TRzHotKeyEdit         Enhanced THotKey--supports Custom Framing.
...
function TRzCustomEdit.GetColor: TColor;
begin
  Result := inherited Color;
end;


procedure TRzCustomEdit.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
...
function TRzCustomEdit.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzCustomEdit.IsFocusColorStored: Boolean;
begin
  Result := NotUsingController and ( ColorToRGB( FFocusColor ) <> ColorToRGB( Color ) );
end;


function TRzCustomEdit.NotUsingController: Boolean;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      RedrawWindow( Handle, @R, 0, rdw_Invalidate or rdw_Frame or rdw_UpdateNow or rdw_NoErase );
    end;
  end
...
procedure TRzCustomEdit.MouseEnter;
begin
...
procedure TRzCustomEdit.MouseLeave;
begin
...
function TRzMemo.GetColor: TColor;
begin
  Result := inherited Color;
end;


procedure TRzMemo.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
    inherited Color := Value;
...
function TRzMemo.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzMemo.IsFocusColorStored: Boolean;
begin
  Result := NotUsingController and ( ColorToRGB( FFocusColor ) <> ColorToRGB( Color ) );
end;


function TRzMemo.NotUsingController: Boolean;
begin
  Result := FFrameController = nil;
end;
...
function TRzMemo.DoMouseWheelDown( Shift: TShiftState; MousePos: TPoint ): Boolean;
begin
...
function TRzMemo.DoMouseWheelUp( Shift: TShiftState; MousePos: TPoint ): Boolean;
begin
...
function TRzRichEdit.GetColor: TColor;
begin
  Result := inherited Color;
end;


procedure TRzRichEdit.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
    inherited Color := Value;
...
function TRzRichEdit.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzRichEdit.IsFocusColorStored: Boolean;
begin
  Result := NotUsingController and ( ColorToRGB( FFocusColor ) <> ColorToRGB( Color ) );
end;


function TRzRichEdit.NotUsingController: Boolean;
begin
  Result := FFrameController = nil;
end;
...
function TRzRichEdit.DoMouseWheelDown( Shift: TShiftState; MousePos: TPoint ): Boolean;
begin
  inherited DoMouseWheelDown( Shift, MousePos );
  if ( GetKeyState( vk_Control ) and $8000 ) = $8000 then
    SendMessage( Handle, em_LineScroll, 0, Mouse.WheelScrollLines )
...
function TRzRichEdit.DoMouseWheelUp( Shift: TShiftState; MousePos: TPoint ): Boolean;
begin
  inherited DoMouseWheelUp( Shift, MousePos );
  if ( GetKeyState( vk_Control ) and $8000 ) = $8000 then
    SendMessage( Handle, em_LineScroll, 0, -Mouse.WheelScrollLines )
...
procedure TRzRichEdit.MouseEnter;
begin
  if Assigned( FOnMouseEnter ) then
    FOnMouseEnter( Self );
end;
...
procedure TRzRichEdit.MouseLeave;
begin
  if Assigned( FOnMouseLeave ) then
    FOnMouseLeave( Self );
end;
...
function TRzHotKeyEdit.GetColor: TColor;
begin
  Result := inherited Color;
end;

procedure TRzHotKeyEdit.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
    inherited Color := Value;
...
function TRzHotKeyEdit.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzHotKeyEdit.IsFocusColorStored: Boolean;
begin
  Result := NotUsingController and ( ColorToRGB( FFocusColor ) <> ColorToRGB( Color ) );
end;


function TRzHotKeyEdit.NotUsingController: Boolean;
begin
  Result := FFrameController = nil;
end;
...
procedure TRzHotKeyEdit.MouseEnter;
begin
  if Assigned( FOnMouseEnter ) then
    FOnMouseEnter( Self );
end;
...
procedure TRzHotKeyEdit.MouseLeave;
begin
  if Assigned( FOnMouseLeave ) then
    FOnMouseLeave( Self );
end;
