{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzStringModuleCreator  This unit implements the TRzStringModuleCreator and
                            the TRzOTAFile classes. These classes are used in
                            the Raize String List editor to implement the Code
...
constructor TRzStringsModuleCreator.Create( const FileName: string; Stream: TStringStream; Age: TDateTime );
begin
  inherited Create;
  FFileName := FileName;
  FStream := Stream;
