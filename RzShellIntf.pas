{===============================================================================
  ...
  Shell Control Pack - Version 1.7a
...
const
  PTSHELLCONTROLS_VERSION = 170;            // Of form "mmnn" where mm is the major version, nn is the minor version
  PTSHELLCONTROLS_PATCHSYM = Ord( 'a' );
