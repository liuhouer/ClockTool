{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzLine               Graphic control that display a single line between
                          opposite corners of the bounding rectangle. Arrows on
                          either end optional.  OnClick event only generated
                          when user clicks on the line, not the bounding
                          rectangle.
