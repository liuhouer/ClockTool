{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzGroupBarEditor     Allows user to add groups to a TRzGroupBar at
                          design-time.
...
begin
  case Index of
    ...
    3: Result := '-';
    4: Result := 'Set Small ImageList';
    5: Result := 'Set Large ImageList';
    6: Result := '-';
    7: Result := 'Align';
  end;
end;
...
begin
  case Index of
    ...
    7: Result := 'Special';
    8: Result := 'Can Close';
    9: Result := 'Divider Visible';
    10: Result := '-';
    11: Result := 'Set Group''s Small ImageList';
    12: Result := 'Set Group''s Large ImageList';
    13: Result := '-';
    14: Result := 'Add Group';
    15: Result := 'GroupBar Style';
  end;
end;
...
begin
  case Index of
    ...
    11: Result := 'RZDESIGNEDITORS_IMAGELIST';
    12: Result := 'RZDESIGNEDITORS_IMAGELIST';
    14: Result := 'RZDESIGNEDITORS_GROUPBAR_ADDGROUP';
...
begin
  ...
  case Index of
    ...
    8: Item.Checked := Group.CanClose;
    9: Item.Checked := Group.DividerVisible;
...
begin
  case Index of
    ...
    8:
    begin
      Group.CanClose := not Group.CanClose;
      Designer.Modified;
    end;

    9:
    begin
      Group.DividerVisible := not Group.DividerVisible;
      Designer.Modified;
    end;
