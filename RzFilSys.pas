{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzFileListBox        Enhanced TFileListBox--supports custom framing, long
                          file names, shell icons.
  TRzDirectoryTree      Tree view that displays directories and sub-directories.
  TRzDirectoryListBox   Enhanced TDirectoryListBox--supports custom framing,
                          long file names, shell icons.
  TRzDriveComboBox      Enhanced TDriveComboBox--supports custom framing, new
                          glyphs.
...
function TRzFileListBox.GetColor: TColor;
begin
  Result := inherited Color;
end;


procedure TRzFileListBox.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
...
function TRzFileListBox.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzFileListBox.IsFocusColorStored: Boolean;
begin
...
procedure TRzFileListBox.MouseEnter;
begin
...
procedure TRzFileListBox.MouseLeave;
begin
...
function TRzDirectoryListBox.GetColor: TColor;
begin
  Result := inherited Color;
end;


procedure TRzDirectoryListBox.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
    inherited Color := Value;
...
function TRzDirectoryListBox.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzDirectoryListBox.IsFocusColorStored: Boolean;
begin
  Result := NotUsingController and ( ColorToRGB( FFocusColor ) <> ColorToRGB( Color ) );
end;
...
procedure TRzDirectoryListBox.MouseEnter;
begin
  if Assigned( FOnMouseEnter ) then
    FOnMouseEnter( Self );
end;
...
procedure TRzDirectoryListBox.MouseLeave;
begin
  if Assigned( FOnMouseLeave ) then
    FOnMouseLeave( Self );
end;
...
function TRzDriveComboBox.GetColor: TColor;
begin
  Result := inherited Color;
end;


procedure TRzDriveComboBox.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
    inherited Color := Value;
...
function TRzDriveComboBox.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzDriveComboBox.IsFocusColorStored: Boolean;
begin
  Result := NotUsingController and ( ColorToRGB( FFocusColor ) <> ColorToRGB( Color ) );
end;
...
procedure TRzDriveComboBox.MouseEnter;
begin
  if Assigned( FOnMouseEnter ) then
    FOnMouseEnter( Self );
end;
...
procedure TRzDriveComboBox.MouseLeave;
begin
  if Assigned( FOnMouseLeave ) then
    FOnMouseLeave( Self );
end;
