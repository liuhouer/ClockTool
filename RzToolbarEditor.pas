{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzToolbarEditor      Adds context menu and advanced editing dialog.
...
begin
  case Index of
    ...
    8: Result := 'Quick Settings';
    9: Result := 'Set RegIniFile';
  end;
end;
...
begin
  case Index of
    ...
    9: Result := 'RZDESIGNEDITORS_REGINIFILE';
  end;
end;
