{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzSelectFolderDialog Dialog-based component used to select folders from the
                          Explorer namespace.
...
begin
  ...
  F.InitHotTracking( FHotTrack, FHighlightColor, FHotTrackColor, FHotTrackColorType );
