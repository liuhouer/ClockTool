{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzBmpButton          Button states represented by bitmaps
...
begin
  ...
  if Enabled and {not FDown and} not IsFocused then
...
procedure TRzBmpButton.MouseEnter;
begin
...
procedure TRzBmpButton.MouseLeave;
begin
  FMouseOverButton := False;
