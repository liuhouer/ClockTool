{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzTrackBar           Slider control for selecting integer position value.
...
begin
  ...
  begin
    HotTrackLight := LighterColor( FHotTrackColor, 30 );
    HotTrackDark := DarkerColor( FHotTrackColor, 30 );
...
procedure TRzTrackBar.MouseEnter;
begin
end;
...
procedure TRzTrackBar.MouseLeave;
begin
