{===============================================================================
  ...
  TRzDBControlEditor          Adds context menu for selecting DataSource
                                components and Data Fields.

  TRzDBListBoxEditor          Adds context menu to TRzDBListBox component.
  TRzDBComboBoxEditor         Adds context menu to TRzDBComboBox component.
  TRzDBLookupComboBoxEditor   Adds context menu to TRzDBComboBox component.
  TRzDBMemoEditor             Adds context menu to TRzDBMemo component.
  TRzDBRichEditEditor         Adds context menu to TRzDBRichEdit component.
  TRzDBDateTimeEditEditor     Adds context menu to TRzDBDateTimeEdit component.
  TRzDBStatusPaneEditor       Adds context menu to TRzDBStatusPane component.
  TRzDBStateStatusEditor      Adds context menu to TRzDBStateStatus component.
  TRzDBLabelEditor            Adds context menu to TRzDBLabel component.
  TRzDBProgressBarEditor      Adds context menu to TRzDBProgressBar component.
  TRzDBButtonEditEditor       Adds context menu to TRzDBButtonEdit component.
  TRzDBNumericEditEditor      Adds context menu to TRzDBNumericEdit component.
  TRzDBSpinEditEditor         Adds context menu to TRzDBSpinEdit component.
  TRzDBSpinnerEditor          Adds context menu to TRzDBSpinner component.
  TRzDBNavigatorEditor        Adds context menu to TRzDBNavigator component.
  TRzDBCheckBoxEditor         Adds context menu to TRzDBCheckBox component.
  TRzDBGridEditor             Adds context menu to TRzDBGrid component.

  TRzSearchFieldProperty      Displays list of available columns in a dataset
  TRzDBDateTimeFormatProperty Provides list of format strings for changing date
                                and time formats.
...
begin
  // Helper function to provide quick access to component being edited. Also makes sure Component is a TRzComboBox.
...
begin
  case Index of
    ...
    3: Result := 'Edit Items...';
    4: Result := '-';
    5: Result := 'csDropDown Style';
    6: Result := 'csDropDownList Style';
    7: Result := '-';
    8: Result := 'Sorted';
    9: Result := 'AllowEdit';
  end;
...
begin
  ...
  case Index of
    5: Item.Checked := ComboBox.Style = csDropDown;
    6: Item.Checked := ComboBox.Style = csDropDownList;
    8: Item.Checked := ComboBox.Sorted;
    9: Item.Checked := ComboBox.AllowEdit;
  end;
end;
...
begin
  case Index of
    ...
    5: ComboBox.Style := csDropDown;
    6: ComboBox.Style := csDropDownList;
    8: ComboBox.Sorted := not ComboBox.Sorted;
    9: ComboBox.AllowEdit := not ComboBox.AllowEdit;
  end;
  if Index in [ 5, 6, 8, 9 ] then
    Designer.Modified;
end;
