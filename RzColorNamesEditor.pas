{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzColorNamesProperty Allows user to customize the names of colors used in a
                          TRzColorComboBox.
  TRzColorNamesEditor   Allows user to customize the names of colors used in a
                          TRzColorComboBox.
