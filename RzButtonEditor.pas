{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzButtonEditor       Adds context menu and editing dialog.
...
begin
  case Index of
    ...
    begin
      ...
      Button.HotTrackColor := $003CC7FF;
      Button.HighlightColor := $00F48D6A;
      Button.Color := $00F0F4F4;
      Designer.Modified;
    end;
...
procedure TRzButtonEditDlg.EdtSizeKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TRzButtonEditDlg.EdtSizeChange(Sender: TObject);
begin
  UpdateWidthHeight;
end;
