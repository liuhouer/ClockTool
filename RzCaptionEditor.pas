{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzCaptionProperty    This unit implements the TRzCaptionProperty property
                          editor, which when registered allows a user to enter
                          multi-line Caption.  This unit also implements the
                          TRzHintProperty property editor, which also allows a
                          user to enter multi-line Hints.
