{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzButtonEdit         Descendant of TRzEdit with two embedded buttons
...
type
  ...
  protected
    ...
    { Property Access Methods }
    procedure SetAlignment( Value: TLeftRight ); override;
...
procedure TRzCustomButtonEdit.SetAlignment( Value: TLeftRight );
begin
  inherited;
  SetEditRect;
end;
...
(*
procedure TRzCustomButtonEdit.UpdateColors;
begin
