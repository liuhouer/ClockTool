{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzSendMessage        Non-visual component that wraps functionality of Simple
                          Messaging API (MAPI) allowing a user to send email
                          messages using a MAPI compliant mail service.
