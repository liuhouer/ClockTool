{===============================================================================
  ...
  ------------------------------------------------------------------------------
  TRzTreeView           Enhanced tree view control.
  TRzCheckTree          Each node in the tree is associated with a check box.
...
function TRzCustomTreeView.GetColor: TColor;
begin
  Result := inherited Color;
end;


procedure TRzCustomTreeView.SetColor( Value: TColor );
begin
  if Color <> Value then
  begin
...
function TRzCustomTreeView.IsColorStored: Boolean;
begin
  Result := NotUsingController and Enabled;
end;


function TRzCustomTreeView.IsFocusColorStored: Boolean;
begin
  Result := NotUsingController and ( ColorToRGB( FFocusColor ) <> ColorToRGB( Color ) );
end;


function TRzCustomTreeView.NotUsingController: Boolean;
begin
...
procedure TRzCustomTreeView.MouseEnter;
begin
...
procedure TRzCustomTreeView.MouseLeave;
begin
